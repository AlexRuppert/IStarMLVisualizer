...
{
	//Belief
	static class BeliefNodePainter
	...
	//Resource
	static class ResourceNodePainter
	extends A.I.F
	implements A.I.FA._K {
	...
	//Softgoal
	static class SoftGoalNodePainter
	extends A.I.F
	implements A.I.FA._K {
	...
	//Position
	static class PositionNodePainter
	extends A.I.F
	implements A.I.FA._K {
	...
	//Actor
	static class ActorNodePainter extends CircleNodePainter
	{
	}
	//Agent
	static class AgentNodePainter extends CircleNodePainter
	{
	...
	//Role
	static class RoleNodePainter extends CircleNodePainter
	{
